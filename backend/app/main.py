...
from app.routers import auth, game_data, characters, groups, monsters, admin, dice, conditions, notes, npcs, resonance, portraits
...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://localhost:5173", "http://192.168.0.110:5173"],
